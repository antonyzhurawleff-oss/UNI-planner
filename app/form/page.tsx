    ...
    <div className="min-h-screen py-12 px-4 bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 md:p-10 space-y-10 border border-gray-100">
          ...
          {/* Grades */}
          <div>
            <label htmlFor="grades" className="block text-sm font-semibold text-gray-800 mb-3 flex items-center">
              <span className="mr-2">📈</span>
              {t("form.grades")} <span className="text-red-500 ml-1">{t("common.required")}</span>
            </label>
            <input
              type="text"
              id="grades"
              name="grades"
              required
              placeholder={t("form.gradesPlaceholder")}
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-gray-800"
            />
          </div>
          ...
          {/* Language Exam */}
          <div>
            <label htmlFor="languageExam" className="block text-sm font-semibold text-gray-800 mb-3 flex items-center">
              <span className="mr-2">📝</span>
              {t("form.languageExam")} <span className="text-red-500 ml-1">{t("common.required")}</span>
            </label>
            <select
              id="languageExam"
              name="languageExam"
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-gray-800"
            >
              <option value="">{t("form.selectExam")}</option>
          ...
          {/* Exam Score */}
          <div>
            <label htmlFor="examScore" className="block text-sm font-semibold text-gray-800 mb-3">
              {t("form.examScore")}
            </label>
            <input
              type="text"
              id="examScore"
              name="examScore"
              placeholder={t("form.examScorePlaceholder")}
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-gray-800"
            />
          </div>
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-800 mb-4 flex items-center">
              <span className="mr-2">💵</span>
              {t("form.budget")} <span className="text-red-500 ml-1">{t("common.required")}</span>
            </label>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              <label className="flex items-center p-4 border-2 border-gray-200 rounded-xl hover:bg-green-50 hover:border-green-400 cursor-pointer transition-all has-[:checked]:border-green-600 has-[:checked]:bg-green-50">
                <input
                  type="radio"
                  name="budget"
                  value="Free"
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">{t("form.budget.free")}</div>
                </div>
              </label>
              <label className="flex items-center p-4 border-2 border-gray-200 rounded-xl hover:bg-blue-50 hover:border-blue-400 cursor-pointer transition-all has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50">
                <input
                  type="radio"
                  name="budget"
                  value="< 3,000"
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">{t("form.budget.per_year")}</div>
                </div>
              </label>
              <label className="flex items-center p-4 border-2 border-gray-200 rounded-xl hover:bg-purple-50 hover:border-purple-400 cursor-pointer transition-all has-[:checked]:border-purple-600 has-[:checked]:bg-purple-50">
                <input
                  type="radio"
                  name="budget"
                  value="3,000 - 10,000"
                ...
                />
                <div>
                  <div className="font-semibold text-gray-800">€3,000 - 10,000</div>
                  <div className="text-xs text-gray-500">{t("form.budget.per_year")}</div>
                </div>
              </label>
              <label className="flex items-center p-4 border-2 border-gray-200 rounded-xl hover:bg-orange-50 hover:border-orange-400 cursor-pointer transition-all has-[:checked]:border-orange-600 has-[:checked]:bg-orange-50">
                <input
                  type="radio"
                  name="budget"
                  value="10,000 - 30,000"
                ...
                />
                <div>
                  <div className="font-semibold text-gray-800">€10,000 - 30,000</div>
                  <div className="text-xs text-gray-500">{t("form.budget.per_year")}</div>
                </div>
              </label>
              <label className="flex items-center p-4 border-2 border-gray-200 rounded-xl hover:bg-pink-50 hover:border-pink-400 cursor-pointer transition-all has-[:checked]:border-pink-600 has-[:checked]:bg-pink-50">
                <input
                  type="radio"
                  name="budget"
                  value="> 30,000"
                  required
                  className="mr-3 h-4 w-4 text-pink-600 focus:ring-pink-500"
                />
                <div>
                  <div className="font-semibold text-gray-800">&gt; €30,000</div>
                  <div className="text-xs text-gray-500">{t("form.budget.per_year")}</div>
                </div>
              </label>
            </div>
